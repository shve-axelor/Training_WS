...
public class StudentDetailImp implements StudentService {
  ...
  public List<StudentDetail> searchData(String names) {
    ...
    Query que =
        emp.get().createQuery("Select s from StudentDetail s where s.sName = '" + names + "'");
  ...
  public String updateData(
    ...
    //	Query qu = emp.get().createQuery( "update StudentDetail SET sName='"+ name + "', sEmail='"+
    // email +"', sAddress='"+ add +"', sContact="+ contact +", sDepartment='"+ department +"'
    // where sId="+ dels);
