  ...
  protected void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    if (action.equals("Register")) {
      ...
      try {
        ...
        if (name.equals("")) {
          response.getWriter().write("Enter the Student Name.");
          flag = 1;
        }
        if (email.equals("")) {
          response.getWriter().write("Enter The Email-Id.");
          flag = 1;
        }
        if (department.equals("default")) {
          response.getWriter().write("Please Select Department of The Student.");
          flag = 1;
        }
        if (flag == 2) {
    ...
    if (flag == 0 || flag == 2) {
      ...
      response
          .getWriter()
          .write("<form action='index.jsp'><input type='submit' value='Click Here' /></form>");
    }
  }
}
