...
<body>
	...
	<form name="registrationForm" method="post" action="StudentDatabaseServlet">
		<span style="display: inline-block; width: 10%;"></span> Student Name: <span
			style="display: inline-block; width: 8%;"></span> <input type="text" size="50" name="sName" /> <br />
		<br /> <span style="display: inline-block; width: 10%;"></span> Student Email: <span
			style="display: inline-block; width: 8%;"></span> <input type="text" size="50" name="sEmail" /> <br />
		<br /> <span style="display: inline-block; width: 10%;"></span> Student Contact No: <span
			style="display: inline-block; width: 5%;"></span> <input type="text" size="50" name="sContact" />

		<br /> <br /> <span style="display: inline-block; width: 10%;"></span> Student Department: <span
		...
		</select> <br /> <br /> <span style="display: inline-block; width: 10%;"></span> Student Address: <span
